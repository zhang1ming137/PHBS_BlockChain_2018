...
## Summary
The emergence of BCH solve the problems caused by the 1MB size limit of Bitcoin such as congestion and high transaction fees. Many even people believe BCH is exactly the real Bitcoin (The intention of BTC is P2P electronic cash system) considering it's low cost. However, the most significant change carried by BCH is the rapid roadmap for technology upgrades. The protocol of BCH update every 6 months and is going to develop the smart contract founctions beyond  a single cash system. No one can deny that the value of BCH comes from Bitcoin. However, with theme of blockchain transfer from hype to implemention, the inclusiveness and advancement of BCH will make it become increasingly recongnized. We can expect more about BCH in the future.
## References
